...
<html lang="en">
    <head>
        ...
        <style type="text/css">
            ...
            .tablee .monitor-wrapper {
                
                background: #050321;
                width: 90%;
                height: 90%;
                box-shadow: 0px 2px 2px 2px rgba(0, 0, 0, 0.3); }
                .tablee .monitor-wrapper .monitor {
                width: 96%;
                height: 77%;
                ...
                .tablee .monitor-wrapper .monitor p#saktigerak {
        ...
        @media screen and (min-width: 1024px) {
            ...
            .tablee {
            width: 45%;
            transform: translateX(-52%) translateY(-170%);
            height: 15%;
            background-color: #f1f5f9; 
        }
            .tablee .monitor-wrapper {
            ...
            to {
                ...
                .heroafdal.d-flex.flex-sm-row.flex-column.align-items-center.mx-lg-0.mx-auto.justify-content-center.gap-3 {
         transform: translateY(243%) translateX(6px); }
         .heroafdal {
        ...
        .header-2-3 .btn-tryy:hover {
        --tw-shadow: inset 0 0px 10px 0 rgba(10, 10, 20, 0.6);
    ...
    x-data="{ page: 'beranda-1', sidebarOpen: false, sidebarExpanded:localStorage.getItem('sidebar-expanded') == 'true' }"
                                ...
                                <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0" x-data="{ open: false }">
                                    ...
                                    <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                                        <ul class="pl-9 mt-1" :class="{ 'hidden': !open }" x-cloak>
                                            <li class="mb-1 last:mb-0">
                                                <a class="block text-gray-400 hover:text-gray-200 transition duration-150 truncate" href="https://haichatbotsakti.site/chatbot">
      ...
      <div>
        <div class="mx-auto d-flex flex-lg-row flex-column hero">
          ...
          <div
            ...
            <div class="tablee centerr">
                <div class="monitor-wrapper centerr">
                    <div class="monitor centerr">
                        <p id="saktigerak">SAKTI (SISTEM APLIKASI KEUANGAN TINGKAT INSTANSI)</p>
                    </div>
                </div>
            </div>
          ...
          <div class="right-column text-center d-flex justify-content-center pe-0">
            <img id="img-fluid" class="h-auto mw-100"
              src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/imgherosakti.png" alt="">
          </div>
...
<a href="https://haichatbotsakti.site/chatbot"> 
<div id="chat-circle" class="btn btn-raised">
        <div >
		<div class="containerchat" id="notifaktif">
			<div class="rectangle">
				<div class="notification-text">
					
					<span>&nbsp;&nbsp;Hai, Chatbot SAKTI Siap Membantu</span>
				</div>
			</div>
		</div>
        ...
        <script src="<?php echo get_stylesheet_directory_uri(); ?>/assets/js/afdal.js"></script>
		<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
        <script>
            var h2 = document.getElementsByTagName("h1");
            for (i = 0; i < h2.length; i++) {
                h2[i].className += ' leading-snug text-gray-800 font-bold mb-2';
            }
            ...
            for (i = 0; i < body.length; i++) {
                body[i].className += ' font-inter antialiased bg-gray-100 text-gray-600 sidebar-expanded';
            }
            var ol = document.getElementsByTagName("ol");
            for (i = 0; i < ol.length; i++) {
                ol[i].className += ' afdalkasihnomor';
            }
            var img = document.getElementsByTagName("img");
            for (i = 0; i < img.length; i++) {
                img[i].className += ' afdalimg';
            }
            document.getElementsByTagName("h1")[0].className += " afdaljudul"
            var p = document.getElementsByTagName("p");
            for (i = 0; i < p.length; i++) {
                p[i].className += ' afdalp';
            }
            // var ol = document.getElementsByTagName("ol");
            // var att = document.createAttribute("style"); 
            // att.value = "decimal !important;";           
            // for (i = 0; i < ol.length; i++) {
...
// holdit(btn, function () { }, 1000, 2);
			...
			setTimeout(function(){
				document.getElementById('notifaktif').className += ' muncul';
			}, 4000); // 10000ms = 10s
