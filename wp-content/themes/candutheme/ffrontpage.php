                                ...
                                <div class="relative max-w-6xl mx-auto px-4 sm:px-6">
                                    ...
                                    <div class="max-w-3xl mx-auto text-center">
                                        ...
                                        >
                                            ...
                                            >
                                            <svg
                                                class="w-4 h-4 flex-shrink-0 ml-4 mr-3"
                                                viewBox="0 0 16 16"
                        ...
                        <div x-data="{ category: '' }" data-aos="fade-up" data-aos-delay="450">
                            ...
                            <div class="flex flex-wrap justify-center -m-1">
                                ...
                                <span
                                    ...
                                    :class="category === '1' ? 'text-white dark:text-teal-400' : 'text-gray-600 dark:text-gray-300'"
                                    >Akuntansi</span
                                >
                                </button>
                                <button
                                ...
                                <span
                                    class="transition duration-150 ease-in-out"
                                    :class="category === '2' ? 'text-white dark:text-purple-400' : 'text-gray-600 dark:text-gray-300'"
                                    >Perpajakan</span
                                >
                                </button>
                                <button
                                ...
                                <span
                                    class="transition duration-150 ease-in-out"
                                    :class="category === '3' ? 'text-white dark:text-indigo-400' : 'text-gray-600 dark:text-gray-300'"
                                    >Keuangan Negara</span
                                >
                                </button>
                                <button
                                class="
                                ...
                                <span
                                    class="transition duration-150 ease-in-out"
                                    :class="category === '4' ? 'text-white dark:text-pink-400' : 'text-gray-600 dark:text-gray-300'"
                                    >Bea Cukai</span
                                >
                                </button>
                            </div>
                            ...
                            <article class="mb-2" x-show="['', '1'].includes(category)">
                                ...
                                <div class="flex items-center px-4 sm:px-8">
                                    ...
                                    >
                                    <circle
                                        class="fill-current text-teal-100 dark:hidden"
                                        cx="16"
                                        cy="16"
                                        r="16"
                                    />
                                ...
                                <div class="pl-6">
                                    ...
                                    <h3
                                        ...
                                        "
                                    >
                                        <a href="#0">Pengenalan Fitur Dasar website</a>
                                    </h3>
                                    </header>
                                    <p class="text-gray-600 dark:text-gray-400">
                                    Gatau Mau nulis apa, karena ini porto juga, jadi lorem aja deh. Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ipsa quas voluptate aperiam atque, rerum omnis earum sed, vel distinctio deleniti maxime numquam exercitationem blanditiis voluptas corporis nesciunt dolores natus dolorem!.
                                    </p>
                                    <a
                                    class="
                                        inline-flex
                            ...
                            <article class="mb-2" x-show="['', '2'].includes(category)">
                                ...
                                <div class="flex items-center px-4 sm:px-8">
                                    ...
                                    >
                                    <circle
                                        class="fill-current text-purple-100 dark:hidden"
                                        cx="16"
                                        cy="16"
                                        r="16"
                                    />
                                ...
                                <div class="pl-6">
                                    ...
                                    <h3
                                        ...
                                        "
                                    >
                                        <a href="#0">Membuat Konten Dinamis</a>
                                    </h3>
                                    </header>
                                    <p class="text-gray-600 dark:text-gray-400">
                                    Penting banget mah ini, tapi ku lorem aja. hehe. Lorem ipsum dolor, sit amet consectetur adipisicing elit. Tempora vel ea illum id, amet mollitia dicta doloremque impedit molestiae. Aliquid nisi recusandae sapiente illo voluptatibus. Obcaecati laboriosam voluptas similique asperiores?.
                                    </p>
                                    <a
                                    class="
                                        inline-flex
                            ...
                            <article class="mb-2" x-show="['', '3'].includes(category)">
                                ...
                                <div class="flex items-center px-4 sm:px-8">
                                    ...
                                    >
                                    <circle
                                        class="fill-current text-indigo-100 dark:hidden"
                                        cx="16"
                                        cy="16"
                                        r="16"
                                    />
                                ...
                                <div class="pl-6">
                                    ...
                                    <h3
                                        ...
                                        "
                                    >
                                        <a href="#0">Cara Impor Template Kustom</a>
                                    </h3>
                                    </header>
                                    <p class="text-gray-600 dark:text-gray-400">
                                    Sudah jelas bakal ku lorem. Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint voluptatum consequatur exercitationem temporibus obcaecati quas pariatur quos illo illum deserunt ipsa debitis modi, nesciunt nobis facere aspernatur ullam. Nemo, asperiores.
                                    </p>
                                    <a
                                    class="
                                        inline-flex
                            ...
                            <article class="mb-2" x-show="['', '4'].includes(category)">
                                ...
                                <div class="flex items-center px-4 sm:px-8">
                                    ...
                                    >
                                    <circle
                                        class="fill-current text-pink-100 dark:hidden"
                                        cx="16"
                                        cy="16"
                                        r="16"
                                    />
                                ...
                                <div class="pl-6">
                                    ...
                                    <h3
                                        ...
                                        "
                                    >
                                        <a href="#0">Hubungkan ke Domain Kustom</a>
                                    </h3>
                                    </header>
                                    <p class="text-gray-600 dark:text-gray-400">
                                        Yuk di lorem aja yuk. Lorem ipsum dolor sit amet consectetur adipisicing elit. Quasi libero mollitia eaque quibusdam quisquam quos, eveniet adipisci tenetur quas similique porro optio exercitationem perspiciatis explicabo unde temporibus dolor dolorem accusantium!
                                    </p>
                                    <a
                                    class="
                                        inline-flex
                            ...
                            <article class="mb-2" x-show="['', '1'].includes(category)">
                                ...
                                <div class="pl-6">
                                    ...
                                    <h3
                                        ...
                                        "
                                    >
                                        <a href="#0">Kata Sandi Halaman</a>
                                    </h3>
                                    </header>
                                    <p class="text-gray-600 dark:text-gray-400">
                                        Lorem aja, kan cuma contoh. Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatibus aspernatur minima, blanditiis quasi temporibus eaque laborum dolore maxime, natus impedit veritatis. Deleniti, cumque obcaecati! Esse fuga dolore quas dolores vel.
                                    </p>
                                    <a
                                    class="
                                        inline-flex
                            ...
                            <article class="mb-2" x-show="['', '4'].includes(category)">
                                ...
                                <div class="pl-6">
                                    ...
                                    <h3
                                        ...
                                        "
                                    >
                                        <a href="#0">Desain berdasar Konten</a>
                                    </h3>
                                    </header>
                                    <p class="text-gray-600 dark:text-gray-400">
                                    Harus mah ini. lorem dulu. Lorem ipsum dolor sit, amet consectetur adipisicing elit. Fugiat ratione, accusantium minima rerum non reiciendis facilis obcaecati, enim optio sequi molestiae laudantium voluptatibus saepe, quos voluptatem vitae exercitationem nam perspiciatis!
                                    </p>
                                    <footer class="text-sm flex items-center mt-3">
                                    <div class="flex flex-shrink-0 mr-3">
                                        <a class="relative" href="#0">
                            ...
                            >
                                <svg
                                class="w-3 h-3 flex-shrink-0 mt-px mr-2"
                                viewBox="0 0 12 12"
                                xmlns="http://www.w3.org/2000/svg"
                                >
                                <path
                            ...
                            <ul class="flex">
                                ...
                                <li class="mx-1">
                                <span
                                    class="inline-flex text-gray-600 dark:text-gray-400"
                                    href="#0"
                                    >…</span
                                >
                                </li>
